...
import { FaFacebookSquare, FaTwitter, FaGithub, FaBasketballBall, FaHeart, FaInstagram } from "react-icons/fa";
    ...
    if(props.nav === true)
        ...
        <Container>
            ...
            <Row className={style.lowerFooter}>
                ...
                <Col md={6} sm={12}>
                    <p>Made with <FaHeart className={style.icon}/> by @DSAThemes</p>
                </Col>
            </Row>
        </Container>
        );
        ...
        return (
            <Container className={style.lowerfooter2}>
